<template>
	<div class="profile-edit">
		<form class="form-widget" @submit.prevent="updateProfile">
			...
			<div class="wrap__info" style="margin-top: 32px;">
				<label for="company_name" class="edit-profile__text-info">Название компании<span>*</span></label>
				<input
					id="company_name"
			...
			<div class="wrap__info">
				<label for="username" class="edit-profile__text-info">ФИО представителя<span>*</span></label>
				<input
					id="username"
					class="edit-profile__input"
					type="text"
			...
			<div class="wrap__info">
				<label for="phone_number" class="edit-profile__text-info">Телефон представителя<span>*</span></label>
				<input
					id="phone_number"
					class="edit-profile__input"
					type="text"
			...
			<div class="wrap__info">
				<label for="inn" class="edit-profile__text-info">ИНН компании<span>*</span></label>
				<input
					id="inn"
					class="edit-profile__input"
					type="text"
			...
			<div class="wrap__info">
				<label for="post" class="edit-profile__text-info">Должность в компании<span>*</span></label>
				<input
					id="post"
					class="edit-profile__input"
					type="text"
					...
					required
					:disabled="!editing"
					placeholder="Генеральный дириректор"
				/>
				<div class="edit">
					<svg 
						@click="editing = true"
			...
			<div class="wrap__info">
				<label for="username" class="edit-profile__text-info">Описание деятельности компании</label>
...
import BuilderUploadImage from "../builder/ui/uploadImageFile.vue";
	...
	const loadProfile = async () => {
		...
		let { data } = await client
			.from('profiles')
			.select(`updated_at, full_name, inn, avatar_url, phone_number, post, company_name, telegram, signature`)
			.eq('id', user.value.id)
			.single()
		...
		if (data) {
			...
			if (!full_name.value || !telegram.value || !inn.value || !phone_number.value || !company_name.value || !post.value) editing.value = true
		}
		loading.value = false
	}
